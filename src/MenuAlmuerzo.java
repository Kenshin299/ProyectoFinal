...
public class MenuAlmuerzo extends JPanel implements CambiarPanel{
	...
	public MenuAlmuerzo() {
		...
		String[] pPrincipales = {"Cerdo BBQ",
				"Ensalada Cesar",
				"Mofongoo",
				"Hamburguer con Tocino",
				"Pasta de camarones",
				"Risotto a la Golden Blue"};
		...
		double[] preciosPrincipales = {0, 800.30,
				270.00,
				450.00,
				560.00,
				375.00,
				325};
		double[] preciosSecundarios = {0, 100.00,
		100.00,
		80.00};
		
		double[] preciosAnadidos = {0, 40.00,
		40.00};
		
		double[] preciosBebidas = {0, 100.00,
		50.00,
		250.00,
		65.00,
		35.00};
		...
		comboBoxPPrincipal.setModel(new DefaultComboBoxModel(new String[] {"",
				"Cerdo BBQ $" + principalAlmuerzo.get(pPrincipales[0]),
				"Ensalada Cesar $" + principalAlmuerzo.get(pPrincipales[1]),
				"Mofongoo $" + principalAlmuerzo.get(pPrincipales[2]),
				"Hamburguer con Tocino $" + principalAlmuerzo.get(pPrincipales[3]),
				"Pasta de camarones $" + principalAlmuerzo.get(pPrincipales[4]),
				"Risotto a la Golden Blue $" + principalAlmuerzo.get(pPrincipales[5])
				}));
		...
		comboBoxPSecundario.setModel(new DefaultComboBoxModel(new String[] {"", 
			...
			"Egg Rolls $" + secundarioAlmuerzo.get(pSecundarios[2])
			}));
		...
		JLabel lblPlatoPrincipal_2 = new JLabel("");
		lblPlatoPrincipal_2.setIcon(new ImageIcon(MenuAlmuerzo.class.getResource("/com/Icons/MenuAlmuerzo.jpg")));
		lblPlatoPrincipal_2.setForeground(Color.WHITE);
		lblPlatoPrincipal_2.setFont(new Font("Tahoma", Font.BOLD, 18));
		lblPlatoPrincipal_2.setBounds(0, 0, 630, 700);
		add(lblPlatoPrincipal_2);
